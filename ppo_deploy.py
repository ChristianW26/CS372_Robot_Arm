...
from safety import setup_safe_exit
...
def main():
    ...
    ### Setup the sim environment to make various checks for sim2real alignment and debugging
    ...
    sim_env = ManiSkillVectorEnv(sim_env, auto_reset=False, ignore_terminations=False)
    ...
    real_env = Sim2RealEnv(sim_env=sim_env, agent=real_agent, control_freq=None)    # control_freq=None defaults to simulation freq
